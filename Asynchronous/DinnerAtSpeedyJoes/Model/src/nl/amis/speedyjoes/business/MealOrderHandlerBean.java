...
@Stateless(name = "MealOrderHandler", mappedName = "DinnerAtSpeedyJoes-Model-MealOrderHandler")
public class MealOrderHandlerBean implements MealOrderHandler, MealOrderHandlerLocal {
    ...
    private void haveKitchenPrepareMeal(Meal meal, ConversationLogger conversationLogger, int level) {
        ...
        try {
            ...
            result="queried";
            conversationLogger.enterLog("Mid Office", level, "Fetched ready mealitems for table "+meal.getMealOrder().getTableNumber(),10);
            ...
            while (set.next()) {
                ...
                if ("A".equals(appetizerOrMain)) {
                    System.out.println("prepared appetizer");
